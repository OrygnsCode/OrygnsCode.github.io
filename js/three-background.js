...
class ThreeBackground {
    ...
    animate() {
        ...
        this.geometries.forEach((mesh, index) => {
            ...
            mesh.position.y += this.scrollY * 0.01 * (index % 2 === 0 ? 1 : -1);
        });
        ...
        // Enhanced camera movement with better scroll handling
        this.cameraTarget.x = this.mouse.smoothX * 1.5;
        this.cameraTarget.y = -this.mouse.smoothY * 1.2;
        
        // Improved scroll behavior - minimal movement to keep galaxy visible
        const scrollInfluence = Math.min(this.scrollY * 0.003, 10);
        this.cameraTarget.z = scrollInfluence;
        ...
        this.camera.position.z = 25 + this.cameraTarget.z;
        
        // Look slightly ahead based on scroll position
        const lookAtY = Math.sin(this.scrollY * 0.001) * 2;
